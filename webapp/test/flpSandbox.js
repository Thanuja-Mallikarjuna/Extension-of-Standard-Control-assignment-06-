		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ExtensionsOfButtons",
									"targetURL": "#comibmextensions-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibmextensions-display": {
								"semanticObject": "comibmextensions",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibm.extensions",
									"url": sap.ui.require.toUrl("com/ibm/extensions")
								}
							}
						}
					}
